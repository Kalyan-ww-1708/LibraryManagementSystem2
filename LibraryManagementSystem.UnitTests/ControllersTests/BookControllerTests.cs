        ...
        [Fact]
            public async Task GetAllBooks_ReturnsOkWithListOfBooks()
            {
                ...
                var books = new List<Book>{
                    new Book { Id = Guid.NewGuid(), BookTitle = "TestBook1", Author = "Author1", Description = "Desc", Isbn = "123", AvailableCopies = 5, TotalCopies = 10 },
            ...
            public async Task CreateBook_ShouldReturnBook_WhenValid()
            {
                ...
                result.BookTitle.Should().Be("TestValid");
